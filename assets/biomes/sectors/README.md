...
Ряды 1 (лавовая порода) и 3–4 (остовы) этого же атласа берёт токсичный сектор
в `biome_sector_defs.gd` — там они перекрашиваются рампой в кислотную зелень,
своего арта у него пока нет.
