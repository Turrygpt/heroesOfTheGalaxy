...
Три файла заметно больше остальных: `space_strategy_map.gd` (~4300 строк),
...
| Файл | Роль |
|---|---|
| `space_strategy_map.gd` (~4300) | ядро: сетка 64×64, ход дня, движение по A*, ресурсы, генерация карты, запуск боёв, фоновая музыка (`_start_music/pause_music/resume_music`) |
