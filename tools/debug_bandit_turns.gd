## Отладочный прогон ИИ марсианских бандитов: печатает по солам казну, стройку, найм и
## перемещения главаря. Не тест — запускается руками при правке баланса
## (пороги в bandit_ai.gd) и удаляется из вывода CI.
extends SceneTree
