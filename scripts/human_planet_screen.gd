...
var BUILDING_DEFS := {
	...
	"mage_guild": {
		...
		"costs": [
			{"credits": 2000, "Продукты": 2, "Руда": 2, "Научные данные": 2, "Энергокристаллы": 2, "Топливо": 2, "Радиоизотопы": 2},
			{"credits": 4000, "Продукты": 4, "Руда": 4, "Научные данные": 4, "Энергокристаллы": 4, "Топливо": 4, "Радиоизотопы": 4},
			{"credits": 6000, "Продукты": 6, "Руда": 6, "Научные данные": 6, "Энергокристаллы": 6, "Топливо": 6, "Радиоизотопы": 6},
			{"credits": 8000, "Продукты": 8, "Руда": 8, "Научные данные": 8, "Энергокристаллы": 8, "Топливо": 8, "Радиоизотопы": 8},
		],
		"requirements": [
			{"townhall": 2},
			{"townhall": 2, "fort": 1},
