...
##
## Шкала ресурсов взята из Heroes of Might & Magic: основную тяжесть цены
## несут кредиты, а ресурсы — небольшая добавка, кратная пяти. Потолок на
## одну постройку: 20 единиц базового ресурса (Продукты, Руда) и 10 единиц
## редкого (Научные данные, Энергокристаллы, Топливо, Радиоизотопы). Это
## посчитано от добычи на карте: шахты дают 2 Продуктов и 4 Руды в сол, а
## редкого ресурса — 1 в сол, ровно как лесопилка и шахта самоцветов в HoMM.
## Младшие постройки редких ресурсов не требуют вовсе. Потолок проверяет
...
var BUILDING_DEFS := {
	"townhall": {
		...
		"costs": [
			...
			{"credits": 5000, "Продукты": 20, "Научные данные": 10, "Энергокристаллы": 5},
		],
		"requirements": [
			{},
			{"fort": 1},
	...
	"fort": {
		...
		"costs": [
			...
			{"credits": 3500, "Руда": 20, "Энергокристаллы": 10, "Радиоизотопы": 5},
		],
		"requirements": [
			{"townhall": 1},
			{"townhall": 2},
	...
	"fighter_yard": {
		...
		"costs": [
			{"credits": 400, "Руда": 5},
			{"credits": 900, "Руда": 10, "Научные данные": 5},
		],
		"requirements": [
			{"fort": 1},
			{"mage_guild": 1},
	...
	"gunship_yard": {
		...
		"costs": [
			{"credits": 900, "Руда": 10, "Топливо": 5},
			{"credits": 1800, "Руда": 15, "Топливо": 10, "Энергокристаллы": 5},
		],
		"requirements": [
	...
	"corvette_yard": {
		...
		"level_names": ["ОБЫЧНЫЙ", "ЭЛИТНЫЙ"],
		"costs": [
			{"credits": 3000, "Руда": 15, "Топливо": 5, "Энергокристаллы": 5},
			{"credits": 5500, "Руда": 20, "Топливо": 10, "Энергокристаллы": 5},
		],
		"requirements": [
	...
	"frigate_yard": {
		...
		"costs": [
			{"credits": 5000, "Руда": 15, "Топливо": 5, "Энергокристаллы": 5, "Радиоизотопы": 5},
			{"credits": 8500, "Руда": 20, "Топливо": 10, "Энергокристаллы": 10, "Радиоизотопы": 5},
		],
		"requirements": [
	...
	"destroyer_yard": {
		...
		"level_names": ["ОБЫЧНЫЙ", "ЭЛИТНЫЙ"],
		"costs": [
			{"credits": 7000, "Руда": 20, "Топливо": 5, "Энергокристаллы": 10, "Радиоизотопы": 5},
			{"credits": 11000, "Руда": 20, "Топливо": 10, "Энергокристаллы": 10, "Радиоизотопы": 10},
		],
		"requirements": [
	...
	"mage_guild": {
		...
		"costs": [
			...
			{"credits": 4000, "Продукты": 5, "Руда": 5, "Научные данные": 5},
			{"credits": 6000, "Продукты": 5, "Руда": 5, "Научные данные": 5, "Энергокристаллы": 5},
			{"credits": 8000, "Продукты": 5, "Руда": 5, "Научные данные": 5, "Энергокристаллы": 5, "Топливо": 5, "Радиоизотопы": 5},
		],
		"requirements": [
			{"townhall": 2},
			{"townhall": 2, "fort": 1},
