...
## Самостоятельная панорама базы марсианских бандитов. Состояние зданий сюда передаётся
...
const BUILDING_TEXTURES := {
	"council_iv": preload("res://assets/planet_surface/bandit/town/council_iv.png"),
	"shield_generator": preload("res://assets/planet_surface/bandit/town/shield_generator.png"),
	"missile_turret": preload("res://assets/planet_surface/bandit/town/missile_turret.png"),
	"fighter_hangar": preload("res://assets/planet_surface/bandit/town/fighter_hangar.png"),
	"assault_hangar": preload("res://assets/planet_surface/bandit/town/assault_hangar.png"),
	"corvette_base": preload("res://assets/planet_surface/bandit/town/corvette_base.png"),
	"frigate_shipyard": preload("res://assets/planet_surface/bandit/town/frigate_shipyard.png"),
	"destroyer_assembly": preload("res://assets/planet_surface/bandit/town/destroyer_assembly.png"),
	"officers_bar": preload("res://assets/planet_surface/bandit/town/officers_bar.png"),
	"university": preload("res://assets/planet_surface/bandit/town/university.png"),
	"exchange": preload("res://assets/planet_surface/bandit/town/exchange.png"),
	"bank": preload("res://assets/planet_surface/bandit/town/bank.png"),
}
...
func _on_building_input(_viewport: Node, event: InputEvent, _shape_index: int, building: Sprite2D) -> void:
	if event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and event.pressed:
		...
		info_body.text = "Уровень %d\nСтроение готово к подключению к экономике марсианских бандитов." % int(building_levels.get(String(building.get_meta("building_id")), 1))
