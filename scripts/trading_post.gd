...
##
## Ресурсная часть цены V ранга подчиняется тому же потолку, что и на верфи
## (не больше ранга единиц каждого ресурса, см. UnitDefs.UNITS), и от той
## пятёрки берётся та же скидка 90% с округлением вниз — 4 единицы каждого
## ресурса, чтобы пост остался чуть выгоднее верфи.
const UNIT_OFFERS := {
	"trader_corvette": {
		"growth": 3,
		"capacity": 3,
	...
	"trader_destroyer": {
		"growth": 1,
		"capacity": 1,
		"cost": {"credits": 1620, "Руда": 4, "Топливо": 4, "Энергокристаллы": 4, "Радиоизотопы": 4},
	},
}
