...
## Постройки марсианской базы. Кредитные цены совпадают с земными (см.
## human_planet_screen.gd:BUILDING_DEFS), ресурсные оставлены выше после
## смягчения стройки игрока: ИИ автоматически забирает месторождения и строит
## без ручного поиска, поэтому одинаковое удешевление ускоряло его сильнее.
## Потолок — 20 базового
