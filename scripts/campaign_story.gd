...
func journal_text() -> String:
	...
	rows.append("Снабжение: верфь (16, 29) — 5 истребителей, терминал (5, 14) — 400 кр., узел (14, 36) — 3 энергокристалла. Запас обновляется в солы 1, 8, 15… Его нужно забрать лично.")
	rows.append("Модернизация: лаборатория (21, 23). Разведка: станция (47, 20). Перед Марсом: ветераны (33, 34) и зарядка (44, 47).")
